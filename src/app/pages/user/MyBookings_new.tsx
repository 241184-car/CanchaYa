                  ...
                  {booking.status === "confirmed" && (
                    <>
                      ...
                      <button 
                        ...
                        className="px-4 py-2 border border-border rounded-lg hover:bg-accent text-sm flex items-center gap-2">
                        <Download className="h-4 w-4" />
                        Descargar comprobante
                      </button>
                      <button 
                        onClick={() => handleCancelBooking(booking.id)}
                        className="px-4 py-2 border border-destructive text-destructive rounded-lg hover:bg-destructive/10 text-sm flex items-center gap-2">
                        <X className="h-4 w-4" />
                        Cancelar reserva
                      </button>
                    </>
